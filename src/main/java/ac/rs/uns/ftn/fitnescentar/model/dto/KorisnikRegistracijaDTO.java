...
public class KorisnikRegistracijaDTO {
    ...
    public KorisnikRegistracijaDTO(Long id, String korisnickoIme, String lozinka, String ime, String prezime, String kontaktTelefon, String emailAdresa, String datumRodjenja, Uloge uloga, boolean aktivan, Long fitnesCentarId) {
        this.id = id;
