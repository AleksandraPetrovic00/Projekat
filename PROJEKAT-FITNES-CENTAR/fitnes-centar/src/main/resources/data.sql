...
INSERT INTO FITNES_CENTAR (naziv, adresa, broj_telefona_centrale, email) VALUES ('NS Gym', 'Strazilovska 12', '021255255', 'ns.gym@gmail.com');
...
INSERT INTO TRENING (naziv, opis, tip_treninga, trajanje, cena, korisnik_trening_id) VALUES ('Trening1', 'Full body workout','HIIT', '120', '600', 3);
INSERT INTO TRENING (naziv, opis, tip_treninga, trajanje, cena, korisnik_trening_id) VALUES ('Trening2', 'Gluteus&Core','CORE', '120', '700', 3);
INSERT INTO TRENING (naziv, opis, tip_treninga, trajanje, cena, korisnik_trening_id) VALUES ('Trening3', 'Tone Up','HIIT', '120', '500', 7);

INSERT INTO SALA (kapacitet, oznaka_sale, fitnescentar_sala_id) VALUES ('20', 'A1', 1);

INSERT INTO OCENA (ocena, korisnik_ocena_id, trening_ocena_id) VALUES ('10', 5, 1);

INSERT INTO TERMIN (broj_prijavljenih_clanova, vreme_odrzavanja, sala_termin_id, trening_termin_id) VALUES ('10', '10.00', 1, 3);
